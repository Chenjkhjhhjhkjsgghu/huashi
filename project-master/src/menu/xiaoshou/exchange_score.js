...
class App extends React.Component{
    ...
    Submit()
    {
        ...
        let value = this.state.borrow;
        axios.post('/exchange_score',value).then(res=>{
    ...
    render(){
        ...
        <div>
            ...
            <span>本次{this.state.dialog.name}积分:<b style={{color:'red'}}>{this.state.borrow.amount}</b></span>
            ...
            <Input addonBefore='当前积分:' value={this.state.borrow.coin} readOnly disabled/>
            ...
            <Radio value={2}>扣会员积分</Radio>
            <Radio value={1}>充会员积分</Radio>
            </RadioGroup>
