...
class App extends React.Component{
    ...
    Submit()
    {
        ...
        let value = this.state.borrow;
        axios.post('/user_transform_coin',value).then(res=>{
    ...
    render(){
        ...
        <div>
            ...
            <div>
            <h2><Icon type="check" style={{color:'green'}}/>转出会员币成功</h2>
            <span>转出ID:<b>{this.state.borrow.id}</b></span>
            <span>本次转出会员币:<b style={{color:'red'}}>{this.state.borrow.amount}</b></span>
            <span>操作后会员币为:<b>{this.state.dialog.Balance}</b></span>
            <span>转入ID:<b>{this.state.borrow.transform_user_id}</b></span>
            <span>操作后会员币为:<b>{this.state.dialog.add}</b></span>
            ...
            <Input addonBefore='转出用户当前币值:' value={this.state.coin} readOnly disabled/>
            ...
            <Input addonBefore='转入用户当前币值:' value={this.state.coin2} readOnly disabled/>
